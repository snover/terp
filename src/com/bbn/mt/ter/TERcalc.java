...
public class TERcalc {
  ...
  public static String[] tokenize(String s) {
	...
	if(normalized) {
      ...
      s = s.replaceAll("'s$", " 's"); // handle possesives
      //      s = s.replaceAll("\\b([^,\\. \\t]+)([\\.,])\\b", "$1 $2"); // tokenize period and comma at end of word, unless there is an earlier period or comma
      //      s = s.replaceAll("\\b([^,\\. \\t]+)([\\.,])\\s*$", "$1 $2"); // tokenize period and comma at end of word, unless there is an earlier period or comma
      //      s = s.replaceAll("\\b([^,\\. \\t]+)([\\.,])\\s+", "$1 $2 "); // tokenize period and comma at end of word, unless there is an earlier period or comma
